...
example_1_generated_sequence = load_json('generated_sequence_example_1.json')
example_2_generated_sequence = load_json('generated_sequence_example_2.json')
example_3_generated_sequence = load_json('generated_sequence_example_3.json')
...
c_modes_pitch_dictionary = {'I': [48, 64, 67, 72], 'I6': [52, 64, 67, 72], 'I64': [43, 64, 67, 72],
                            ...
                            'bIV6': [44, 57, 65, 72], 'b0IV7': [41, 64, 68, 72], 'bIV7': [41, 64, 68, 72],
...
midifile_example_1 = generate_midi_sequence(example_1_generated_sequence)
with open("example_1_output.mid", 'wb') as outf:
    midifile_example_1.writeFile(outf)

midifile_example_2 = generate_midi_sequence(example_2_generated_sequence)
with open("example_2_output.mid", 'wb') as outf:
    midifile_example_2.writeFile(outf)

midifile_example_3 = generate_midi_sequence(example_3_generated_sequence)
with open("example_3_output.mid", 'wb') as outf:
    midifile_example_3.writeFile(outf)
