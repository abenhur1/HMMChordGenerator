...
c_major_pitch_dictionary = {'I': [48, 64, 67, 72], 'I6': [52, 64, 67, 72], 'I64': [43, 64, 67, 72],
                            'I7': [48, 59, 64, 67], 'I9': [48, 62, 64, 72], 'V': [43, 62, 67, 71],
                            'V6': [47, 55, 67, 74], 'V7': [43, 62, 65, 71], 'V65': [47, 65, 67, 74],
                            'V43': [50, 65, 67, 71], 'V42': [53, 62, 67, 71], 'VII6': [50, 62, 65, 71],
                            'VII7o/': [47, 65, 69, 74], 'VII7o': [47, 65, 68, 74], 'VII43o': [53, 62, 68, 71],
                            ...
                            'IV7': [41, 64, 69, 72], 'VI': [45, 57, 64, 72], 'VI6': [48, 57, 64, 69],
                            'VI9': [45, 60, 64, 71], 'VI7': [45, 64, 67, 72], 'VI65': [48, 57, 67, 69],
                            'VI43': [52, 64, 67, 72], 'VI42': [43, 64, 69, 72], 'III': [40, 64, 67, 71],
                            'III6': [43, 55, 64, 71], 'III7': [52, 59, 67, 74], 'VII': [47, 53, 62, 74],
                            'IV42maj': [53, 57, 65, 72], 'IV7maj': [41, 69, 72, 76], 'VII42o': [44, 62, 65, 71],
                            'VII4+o': [48, 65, 68, 71, 74], 'I2': [47, 64, 67, 72], 'bIV': [41, 65, 68, 72],
                            'bI64': [43, 63, 67, 72], 'V9': [43, 57, 62, 71], 'VII65o/': [50, 65, 69, 71],
                            'bIII': [39, 63, 67, 70], 'II64': [45, 62, 65, 74], 'It+6': [44, 60, 66, 72]}
...
def generate_midi_sequence(generated_midi_notation_sequence, start_time=0, tempo=120, track=0, volume=100):
    ...
    for chord_index in range(sequence_length):
        ...
        chord_pitches = c_major_pitch_dictionary[chord[1:]]
...
print(midi_notation_to_functional(baroque_markov_model_order_1_generated_sequence))
print(midi_notation_to_functional(baroque_markov_model_order_2_generated_sequence))
print(midi_notation_to_functional(chopin_markov_model_order_1_generated_sequence))
print(midi_notation_to_functional(chopin_markov_model_order_2_generated_sequence))
